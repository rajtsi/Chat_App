...
function Sidebar({
    ...
    const filteredChats = useMemo(() => {
        return chats.filter((chat) => {
            ...
            const name = otherMember?.displayName || chat.name || "";
        ...
        <div className="w-[30%] bg-[#202c33] border-r border-gray-700 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto min-h-0">
                ...
                {filteredChats.length > 0 && (
                    <div className="px-3 py-2">
                        <h2 className="text-gray-400 text-sm mb-2">Chats</h2>

                        {filteredChats.map((chat) => {
                            console.log("Rendering chat item for chat", chat);
                            const otherMember = chat.members?.find(
                                (member) => member.id !== currentUser.id
                            );
                            return (
                                <ChatItem
                                    ...
                                    isOnline={!!onlineUsers[otherMember?.id]}
                                />
                            );
                        })}
                    </div>
                ...
                {searchedUsers.length > 0 && (
                    <div className="px-3 py-2">
                        <h2 className="text-gray-400 text-sm mb-2">Users</h2>
            ...
            <div
                onClick={() => {
                    ...
                    openProfileModal(currentUser, true);
                }}
